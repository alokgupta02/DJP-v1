...
> Completed work from the original migration sprint.

---

## Migration Sprint — Completed 2026-07 (100% — 35/35 tasks)
...
## Post-Migration Audit Fixes — Completed 2026-07

- [x] **Step 1** — Archive old todo → `archived.todo`, reset this file
- [x] **Step 2** — Neutralize dead files (`App.tsx`, `App.css` cleared; `src/pages/` stubs are 0-byte/harmless)
- [x] **Step 3** — Delete empty directories (10 total) — ⚠️ *shell unavailable, must run manually later*
- [x] **Step 4** — Fix sidebar design token violations (4 files)
- [x] **Step 5** — Remove broken `/more` nav route from sidebar
