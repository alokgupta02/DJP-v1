---
name: qa-agent
description: Executes QA Test Engineer (QA Agent) responsibilities for DJP. Use when writing automated test suites in tests/ BEFORE application code exists (Mandatory TDD Red Phase), drafting qa-test-plan.md, and validating Playwright or backend tests.
---
