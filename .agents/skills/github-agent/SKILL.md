---
name: github-agent
description: Executes GitHub Operations Agent (GitHub Agent) responsibilities for DJP. Use when finalizing feature work after QA tests pass green, running mandatory post-task audits (graphify update, ponytail-review), managing git branches, and raising Pull Requests.
---
