---
name: pm-agent
description: Executes Product Manager (PM Agent) responsibilities for DJP. Use when reading simple 1-2 line user requests in /todo.md, breaking down tasks across target domains (FE, BE, QA), formulating clarifying questions, defining acceptance criteria, and writing docs/execution/<feature>/PRD.md.
---
