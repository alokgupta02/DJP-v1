    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/djp/api/v1/issues/**", "/djp/api/v1/discussions/**", "/djp/api/v1/polls/**", "/djp/api/v1/interactions/**", "/djp/api/v1/petitions/**", "/djp/api/v1/insights/**", "/djp/api/v1/profiles/**").permitAll()
