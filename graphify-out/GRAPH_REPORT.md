...
## Corpus Check
- 426 files · ~260,088 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2685 nodes · 2890 edges · 344 communities (215 shown, 129 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 51 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `75fcec57`
...
1. `User` - 40 edges
2. `Issue` - 35 edges
3. `📜 Completed Resolutions Ledger` - 27 edges
4. `AuditLog` - 23 edges
...
Cohesion: 0.23
Nodes (8): IssueController, CrossOrigin, RequestMapping, RestController, AuditLogService, Logger, Service, Transactional
...
Cohesion: 0.21
Nodes (13): AuditLogRepository, Repository, IssueRepository, Issue, Repository, Repository, UserRepository, IssueIntegrationTest (+5 more)
...
Cohesion: 0.09
Nodes (5): AuditLog, Entity, PrePersist, Table, Test
...
## Knowledge Gaps
- **1423 isolated node(s):** `attest-plan.sh script`, `gate-stop.sh script`, `ledger-summary.sh script`, `set-active-plan.sh script`, `com.djp:backend` (+1418 more)
...
- **Why does `User` connect `User` to `rendering-usetransition-loading.md`, `IssueCreateRequestDto`, `OAuth2SuccessHandler`, `UserRepository`, `JwtTokenProvider`, `Issue`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `Issue` connect `Issue` to `IssueCreateRequestDto`, `User`, `UserRepository`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `UserRepository` connect `UserRepository` to `async-cheap-condition-before-await.md`, `rendering-usetransition-loading.md`, `IssueCreateRequestDto`, `AuthController`, `User`, `JwtTokenProvider`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
