# Graph Report - DJP-v1  (2026-07-30)

## Corpus Check
- 1063 files · ~860,684 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11820 nodes · 28069 edges · 791 communities (590 shown, 201 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 3314 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0cec0164`
...
- 🌟 **Digital Janata Party (DJP) Vision**
- compilerOptions
- 🏗️ System Architecture
- 🚀 **Deployment & Hosting Guide**
- 🧠 **Accessible & Visual Learning Guide (Dyslexia-Friendly)**
- 🎨 **Design Principles & UX System**
- IssuesPage.tsx
- Button.tsx
- URL Map — DJP Citizen App
- analyze-project
- stop-server.sh
...
- DJP QA & Test Suite — Todo (`tests/test-todo.md`)
- client-swr-dedup.md
...
- `SidebarProvider()` --indirect_call--> `handleKeyDown()`  [INFERRED]
  bmad/frontend/src/shared/components/sidebar/SidebarContext.js → .agents/skills/impeccable/scripts/live-browser.js
- `SidebarProvider()` --indirect_call--> `handleKeyDown()`  [INFERRED]
  bmad/frontend/src/shared/components/sidebar/SidebarContext.tsx → .agents/skills/impeccable/scripts/live-browser.js
- `OTPPage()` --indirect_call--> `i()`  [INFERRED]
  bmad/frontend/src/features/auth/OTPPage.js → mobile/.dart_tool/flutter_build/823c2793cb5e7b8c87fa50b60761e005/main.dart.js
- `OTPPage()` --indirect_call--> `i()`  [INFERRED]
  bmad/frontend/src/features/auth/OTPPage.tsx → mobile/.dart_tool/flutter_build/823c2793cb5e7b8c87fa50b60761e005/main.dart.js
...
## Communities (791 total, 201 thin omitted)
...
Cohesion: 0.03
Nodes (94): A3(), a45(), a4s(), a4t(), aA1(), aA5(), aA6(), aA7() (+86 more)
...
Cohesion: 0.03
Nodes (149): addManualContextText(), applyGlobalBarLabelState(), applyPlaceholderSizingStyles(), applySvelteComponentVariantStyle(), averageRgb01(), bindEditBadgeProxy(), bufferToBase64(), buildCollapsible() (+141 more)
...
Cohesion: 0.07
Nodes (29): ARCH-003: Contradictory Directory Structure Across Docs, ARCH-005: Missing API Gateway Implementation, ARCH-006: Undocumented Async Event Bus & pgvector Semantic Store Pipelines, DATA-001: Missing Database Migration Engine (Flyway/Liquibase) vs Unsafe `ddl-auto: update`, DATA-003: Missing Database Indexes & Performance Optimizations in Schema, DEVOPS-002: Missing Multi-Stage Dockerfile for Frontend & Local `docker-compose.yml`, DOC-005: Missing Operational Runbooks & Backend Deployment Guide, DOC-006: AI Service Lacks Architecture & API Documentation (+21 more)

### Community 7 - "Process"
Cohesion: 0.03
Nodes (129): ANIMATION_VALUE_KEYWORDS, borderColorsFromStyle(), borderWidthsFromStyle(), checkClippedOverflow(), checkEdgeFlushCardsDOM(), checkElementBlinkingCursorDOM(), checkElementClippedOverflow(), checkElementClippedOverflowDOM() (+121 more)

### Community 8 - "💻 **Frontend Engineering Guide**"
Cohesion: 0.08
Nodes (26): 1️⃣ Citizen, 1. 👤 Citizen First, 2. 🔁 Reuse Before Create, 3. 🧩 Composition Over Duplication, 4. 📁 Feature-Oriented Development, 5. 🛡️ Strict Type Safety, ♿ Accessibility (WCAG 2.1 AA Mandatory), 🤖 AI Agent Rules (+18 more)
...
Cohesion: 0.04
Nodes (65): a2x(), a3D(), a3O(), a5g(), a5i(), a5O(), a76(), a9I() (+57 more)
...
Cohesion: 0.07
Nodes (79): applyConfigureBarChrome(), applyParamDefaults(), applyParamValue(), applySavedSessionMeta(), buildCyclingRow(), buildDots(), buildGeneratingRow(), buildParamsPanel() (+71 more)
...
Cohesion: 0.04
Nodes (12): Discussion, Entity, PrePersist, PreUpdate, Table, User, Discussion, Issue (+4 more)
...
### Community 24 - "Writing Guidelines for Postgres References"
Cohesion: 0.12
Nodes (15): 1. Concrete Transformation Patterns, 2. Error-First Structure, 3. Quantified Impact, 4. Self-Contained Examples, 5. Semantic Naming, Code Example Standards, Comments, Impact Level Guidelines (+7 more)

### Community 25 - "5. Re-render Optimization"
Cohesion: 0.12
...
Cohesion: 0.12
Nodes (18): InteractionController, Authentication, Comment, CrossOrigin, Follow, GetMapping, Operation, PostMapping (+10 more)
...
Cohesion: 0.02
Nodes (206): q(), A2(), a27(), a2a(), a2t(), a2U(), a3M(), a53() (+198 more)

### Community 36 - "aggregate_benchmark.py"
Cohesion: 0.17
Nodes (14): CrossOrigin, GetMapping, Operation, RequestMapping, ResponseEntity, RestController, Tag, RepresentativeController (+6 more)
...
### Community 43 - "📚 Pattern Library"
Cohesion: 0.17
Nodes (12): 1️⃣ 🧭 Pattern 1: Responsive Sidebar Toggle, 2️⃣ ✨ Pattern 2: Active State Management, 3️⃣ 📈 Pattern 3: Chart.js Initialization, 4️⃣ ⚡ Pattern 4: DOM Query Caching, 5️⃣ 🎯 Pattern 5: Event Delegation, 6️⃣ 🏷️ Pattern 6: HTML5 Data Attributes, 7️⃣ 📑 Pattern 7: Tab Navigation Class Toggling, 🚫 Common Anti-Patterns to Avoid (+4 more)

### Community 44 - "📱 **Layout & Responsive Design Specification**"
Cohesion: 0.17
...
### Community 56 - "React Best Practices"
Cohesion: 0.13
...
Cohesion: 0.38
Nodes (3): 1. Global Tech Stack & Constants, 2. Monolithic Module Matrix, 🛠️ **Modular Monolith Backend Architecture & Tech Stack**
...
Cohesion: 0.15
Nodes (13): 1. Goal & Architecture Overview, 2. Directory & Package Structure, 3. Database Schema Design, 4. REST API Endpoint Contracts, 5. Phased Implementation Plan, 6. Verification & Test Plan, ⚙️ **Backend API Engineering Specification**, Phase 1: Project Setup & OAuth2 (MVP 1) (+5 more)
...
Cohesion: 0.10
Nodes (60): abortSvelteComponentInjection(), applyEditing(), cancelEditing(), cancelEditingToPicking(), cancelInsertConfigure(), captureAndEmit(), cleanup(), cleanupAcceptedSession() (+52 more)
...
Cohesion: 0.15
Nodes (13): 📌 ADR-001: Progressive Disclosure Pattern, 📌 ADR-002: Chart.js for Visualizations, 📌 ADR-003: Mobile-First Design, 📌 ADR-004: Shared React 18 & Vite Foundation, 📌 ADR-005: Static & CDN Edge Hosting, 📌 ADR-006: Modular Microservices Backend, 📌 ADR-007: Dynamic Ranks & Paid Leader Gate, 📌 ADR-008: Modular Monolith for MVP (+5 more)
...
Cohesion: 0.11
Nodes (16): 💬 **Civic Discussion UX Specification**, 📑 Data Schema & UI Fields, 🌟 Overview, 📚 Related Documentation, 💡 UX & Content Guidelines, 🚨 **Civic Issue Reporting UX Specification**, 📑 Issue Reporting Fields & UI Presentation, 📑 Issue Resolution & Verification Schema (+8 more)
...
Cohesion: 0.00
Nodes (398): a1W(), a1Z(), a21(), a22(), a25(), a26(), a2C(), a2F() (+390 more)
...
### Community 76 - "stop-server.sh"
Cohesion: 0.25
Nodes (8): 1. 📋 Universal Front Metadata Header Schema (`All .md Files`), 2. 🏗️ Standardized Schemas for Specialized File Types, 3. 🚀 Future Format Extensibility (`Continuous Guardrail Growth`), A. Canonical Technical Debt Registers (`<type>-debt.md`), B. Active Execution Backlogs (`<type>-audit-recom.md`), C. Historical Resolution Ledgers (`<type>-audit-log.md`), ⚠️ Special Rule for Agent Skills & Rules Files (`.agents/skills/` & `.agents/rules/`), Universal Markdown Metadata & Structural Guardrail

### Community 77 - "1. Eliminating Waterfalls"
Cohesion: 0.15
...
Cohesion: 0.03
Nodes (26): PollCreateRequestDto, PollResponseDto, Mapper, Mapping, Poll, PollMapper, Entity, PrePersist (+18 more)

### Community 83 - "index.ts"
Cohesion: 0.38
Nodes (4): Input, InputProps, SearchBox, SearchBoxProps

### Community 84 - "Supabase Postgres Best Practices"
Cohesion: 0.33
...
### Community 87 - "CHECKLIST.md"
Cohesion: 0.40
Nodes (4): Before Starting, Theme, UI, Validation

### Community 88 - "Analysis Policy"
Cohesion: 0.40
Nodes (4): Analysis Policy, Default stance, Forbidden behavior, Required behavior

### Community 89 - "8. Advanced Patterns"
Cohesion: 0.31
...
### Community 90 - "User"
Cohesion: 0.03
Nodes (40): AuthController, ApiResponses, Authentication, CrossOrigin, GetMapping, JwtTokenProvider, Operation, PostMapping (+32 more)
...
### Community 100 - "React + TypeScript + Vite"
Cohesion: 0.50
Nodes (3): Expanding the ESLint configuration, React Compiler, React + TypeScript + Vite

### Community 101 - "DiscussionDetailPage.tsx"
Cohesion: 0.01
Nodes (285): bt(), fe(), yt(), a1V(), a20(), a29(), a2e(), a2G() (+277 more)

### Community 102 - "NotificationsPage.tsx"
Cohesion: 0.12
Nodes (6): Entity, Table, User, Notification, Transactional, User
...
Cohesion: 0.10
Nodes (44): checkBorders(), checkColors(), checkElementAIPaletteDOM(), checkElementBorders(), checkElementBordersDOM(), checkElementColors(), checkElementColorsDOM(), checkElementGlowDOM() (+36 more)
...
Cohesion: 0.03
Nodes (72): aN_(), gOt(), sagI(), sagL(), sagM(), sagN(), sah1(), sah2() (+64 more)
...
### Community 119 - "spec-document-reviewer-prompt.md"
Cohesion: 0.33
Nodes (6): 1. Functional Verification, 2. Test-Driven Development (TDD) Compliance, 3. Code Quality & Standards, 4. Cleanup & Optimization, 5. Repository & Documentation Synchronization, 📋 Definition of Done Checklist

### Community 152 - "# Technical Debt"
Cohesion: 0.17
Nodes (9): DJP Backend Microservices, DJPv1 Synchronization, Overview, Running Locally, 📜 Completed Resolutions Ledger, 📔 DJP Backend Technical Debt Resolution & Audit Log (`be-audit-log.md`), 📋 How to Use This Log (Agent & Developer Instructions), 🛠️ Standard Resolution Entry Template (+1 more)
...
Cohesion: 0.06
Nodes (32): 📜 Completed Resolutions Ledger, [EXAMPLE] ID: DOC-001 — Missing `api-spec.yaml` (OpenAPI Contract), [RESOLVED] ID: ARCH-001 — Modular Monolith Architectural Shift, [RESOLVED] ID: ARCH-004 — Frontend Shared Packages Are Empty Shells & Structure Discrepancy, [RESOLVED] ID: CFG-001 / TEST-001 — Split Environment Profiles & Scaffold Integration Tests, [RESOLVED] ID: DATA-002 — Missing JPA Repository Interfaces & Custom Queries, [RESOLVED] ID: DATA-003 — Missing Database Indexes & Performance Optimizations in Schema, [RESOLVED] ID: DATA-004 — H2 vs PostgreSQL Dialect Gaps & Connection Pool Settings Unverified (+24 more)
...
### Community 174 - "js-early-exit.md"
Cohesion: 0.50
...
Cohesion: 0.04
Nodes (42): CreatePostPage, CreatePostPageWithSuspense, DiscussionDetailPage, DiscussionDetailPageWithSuspense, DiscussionsPage, DiscussionsPageWithSuspense, FeedPage, FeedPageWithSuspense (+34 more)
...
Cohesion: 0.08
Nodes (46): a4A(), ac0(), acM(), ad1(), ae7(), aG1(), aH_(), art() (+38 more)
...
Cohesion: 0.33
Nodes (5): ✅ Completed Tasks, DJP Prototype User Request Intake Portal (`web-app = prototype`), Phase 1: Bare-Minimum Prototype Setup, Phase 2: Progressive Microservice Expansion, 🚀 Remaining Backlog

### Community 222 - "__init__.py"
Cohesion: 0.08
Nodes (45): detectUrl(), measureContentHiddenAfterReveal(), runVisualContrastFallback(), serializeDesignSystemForBrowser(), blankCssComments(), CSS_IN_JS_EXTENSIONS, detectText(), extFromFilePath() (+37 more)

### Community 223 - "Issue"
Cohesion: 0.04
Nodes (28): IssueController, ApiResponses, AuditLogService, Authentication, CrossOrigin, GetMapping, Issue, IssueCreateRequestDto (+20 more)

### Community 224 - "🤖 Instructions for the Agent"
Cohesion: 0.22
Nodes (8): Build Feature (Master End-to-End Pipeline), 🤖 Instructions for the Agent, Step 1: 👑 PM Agent (Scope & Requirements), Step 2: 🏛️ Tech Arch Agent (Architecture), Step 3: 🧭 TL Agent (Surgical Specification), Step 4: 🧪 QA Agent (TDD Red Phase), Step 5: 🎨 / ⚙️ FE & BE Agents (TDD Green Phase), Step 6: 🐙 GitHub & CI/CD Agent (Git, PR & Pipeline Manager)
...
Cohesion: 0.02
Nodes (275): $2(), $2$from$to(), a0(), a1(), a36(), a40(), a46(), a69() (+267 more)

### Community 241 - "AuthController"
Cohesion: 0.09
Nodes (5): Entity, Table, User, Petition, PetitionRepository
...
Cohesion: 0.06
Nodes (48): AuditLogRepository, AuditLog, Repository, IssueRepository, Issue, Repository, AuditLogRepository, AuditLog (+40 more)
...
Cohesion: 0.20
Nodes (10): 1. Configure Environment Variables, 1. Configure Environment Variables, 2. Install Packages & Run Dev Server, 2. Spring Profiles Separation, 3. Build & Run Command Queue, ⚙️ Backend Module Setup (`backend/springboot/`), 🚀 **DJP Developer Onboarding & Local Setup Guide**, 💻 Frontend Module Setup (`frontend/`) (+2 more)

### Community 247 - "BackendApplication"
Cohesion: 0.60
...
Cohesion: 0.05
Nodes (87): a1X(), a3A(), a3B(), a3V(), a3w(), a3x(), a3z(), a5K() (+79 more)

### Community 256 - "Spring Boot Best Practices"
Cohesion: 0.18
Nodes (10): Circuit Breaker Pattern, Communication Patterns, microservices-patterns — detailed patterns and worked examples, Pattern 1: By Business Capability, Pattern 1: Synchronous REST Communication, Pattern 2: API Gateway, Pattern 2: Asynchronous Event-Driven, Pattern 3: Saga Pattern (Distributed Transactions) (+2 more)

### Community 257 - "Communication Patterns"
Cohesion: 0.22
Nodes (8): 1. Service Decomposition Strategies, 2. Communication Patterns, 3. Data Management, 4. Resilience Patterns, Core Concepts, Detailed patterns and worked examples, Microservices Patterns, When to Use This Skill
...
### Community 287 - "DJPv1 OPERATIONAL RULES"
Cohesion: 0.50
...
Cohesion: 0.33
Nodes (5): 2026-07-12 Session, Current Sprint, DJPv1 BACKEND ACTIVE STATE, Session Delta Logs, Task Breakdown

### Community 292 - "DJPv1 FRONTEND ACTIVE STATE"
Cohesion: 0.33
Nodes (5): 2026-07-12 Session, Current Sprint, DJPv1 FRONTEND ACTIVE STATE, Session Delta Logs, Task Breakdown

### Community 293 - "DJPv1 QA & TESTS ACTIVE STATE"
Cohesion: 0.33
Nodes (5): 2026-07-12 Session, Current Sprint, DJPv1 QA & TESTS ACTIVE STATE, Session Delta Logs, Task Breakdown

### Community 294 - "DJPv1 BACKEND IDENTITY"
Cohesion: 0.50
Nodes (3): Communication Guardrails, DJPv1 BACKEND IDENTITY, Technical Profile

### Community 295 - "DJPv1 BACKEND OPERATIONAL RULES"
Cohesion: 0.50
Nodes (3): Code Quality Standards, Context Allocation, DJPv1 BACKEND OPERATIONAL RULES

### Community 296 - "DJPv1 FRONTEND IDENTITY"
Cohesion: 0.50
Nodes (3): Communication Guardrails, DJPv1 FRONTEND IDENTITY, Technical Profile

### Community 297 - "DJPv1 FRONTEND OPERATIONAL RULES"
Cohesion: 0.50
Nodes (3): Code Quality Standards, Context Allocation, DJPv1 FRONTEND OPERATIONAL RULES

### Community 298 - "DJPv1 QA & TESTS IDENTITY"
Cohesion: 0.50
Nodes (3): Communication Guardrails, DJPv1 QA & TESTS IDENTITY, Technical Profile

### Community 299 - "DJPv1 QA & TESTS OPERATIONAL RULES"
Cohesion: 0.50
...
Cohesion: 0.07
Nodes (3): Entity, Table, Representative
...
Cohesion: 0.33
Nodes (5): 1. Role Overview & Boundary, 2. Mandatory Inputs & Outputs, 3. Required Skills & Lifecycle Workflows, 4. Execution Guardrails & Checklist (`Git & CI/CD Section`), 🐙 GitHub & CI/CD Agent (Git Operations, PR Review & Pipeline Manager) Operating Specification
...
Cohesion: 0.07
Nodes (55): ADVISORY_RULES, applyConfigSource(), applyDetectorConfigSource(), clampByte(), cleanIgnoreValueDisplay(), cloneDefaultConfig(), CO_SCAN_STYLE_NAMES, coLocatedStylesheets() (+47 more)
...
Cohesion: 0.09
Nodes (50): ae(), be(), Ce(), Ct(), de(), dt(), _e(), Ee() (+42 more)
...
### Community 338 - "📋 Standard Mandatory Steps for Every Completed Task"
Cohesion: 0.20
...
Cohesion: 0.12
Nodes (20): canRestoreManualEditElement(), cssIdent(), directMixedTextRestoreNodes(), documentRefClassSuffix(), documentRefIdSuffix(), documentRefSegment(), elementMatchesManualRefSegment(), findManualEditRestoreElement() (+12 more)
...
### Community 343 - "a"
Cohesion: 0.08
Nodes (51): isLiveServerPidReachable(), matchesTemplateExtension(), acceptCli(), acceptReceiptPath(), argVal(), buildAcceptedWrappedSource(), buildCarbonizeReplacement(), decodeHtmlAttr() (+43 more)
...
### Community 346 - "t"
Cohesion: 0.02
Nodes (362): compareScreenshotContrast(), $3(), a(), a2N(), a3e(), a3F(), a3J(), a3K() (+354 more)
...
### Community 349 - ".$1"
Cohesion: 0.02
Nodes (130): a3S(), A4(), a52(), a5q(), a5z(), a6h(), a6k(), a6p() (+122 more)

### Community 350 - "$0"
Cohesion: 0.03
Nodes (136): $0(), $1(), $1$allowPlatformDefault(), $2$alignmentPolicy(), a42(), a4r(), a5M(), a5N() (+128 more)

### Community 351 - "User"
Cohesion: 0.06
Nodes (8): User, User, Entity, JsonIgnoreProperties, Table, User, User, User

### Community 352 - "Y"
Cohesion: 0.06
Nodes (31): Addcommentrequest, Authresponsedto, Castvoterequest, Categorybreakdown, Comment, Departmentefficiency, Discussioncreaterequestdto, Discussionresponsedto (+23 more)
...
### Community 356 - "User"
Cohesion: 0.07
Nodes (6): PostMapping, Entity, JsonIgnoreProperties, Table, User, User

### Community 357 - "v"
Cohesion: 0.10
Nodes (35): analyzeVisualContrastCandidate(), blendRgba(), browserColorsClose(), browserHasDirectText(), browserRadiusTokens(), browserSampleText(), checkElementDesignSystemDOM(), clampByte() (+27 more)
...
### Community 359 - "bn"
Cohesion: 0.10
Nodes (4): IssueCreateRequestDto, IssueCreateRequestDto, PollUpdateRequestDto, Size
...
### Community 361 - "cT"
Cohesion: 0.25
Nodes (8): 🧠 Behavioral Patterns, 💡 Design Implications for Vikram, 😤 Frustrations & Pain Points, 🎯 Goals & Motivations, 📊 Key Metrics to Track for This Persona, Persona 4: Vikram Joshi — *"The Policy Thinker"*, 📋 Profile Summary, 📱 User Journey (Typical Session)
...
### Community 364 - ".$0"
Cohesion: 0.14
Nodes (20): FeedPetition, fetchDiscussions(), fetchIssues(), fetchPetitions(), fetchPolls(), mapDiscussion(), mapIssue(), mapPoll() (+12 more)
...
Cohesion: 0.09
Nodes (23): devDependencies, eslint, @eslint/js, eslint-plugin-react-hooks, eslint-plugin-react-refresh, globals, jsdom, @playwright/test (+15 more)

### Community 367 - ".$2"
Cohesion: 0.11
Nodes (32): actionLabel(), bindConfigureCountPillTooltip(), bindConfigureInlineControlHover(), bindConfigureModifierPillHover(), buildConfigureActionControl(), buildConfigureCountControl(), buildConfigureRow(), buildConfigureSubmitButton() (+24 more)
...
### Community 371 - "gK"
Cohesion: 0.06
Nodes (62): a23(), a2b(), a30(), a5B(), a7X(), a8b(), a8G(), a8M() (+54 more)
...
Cohesion: 0.04
Nodes (51): IssueCreateRequestDto, Schema, BackendApplicationTests, Test, BaseIntegrationTest, ActiveProfiles, SpringBootTest, BackendApplicationTests (+43 more)
...
Cohesion: 0.05
Nodes (33): INPUTS, OTPPage(), Button, ButtonProps, ButtonSize, ButtonVariant, sizeClasses, variantClasses (+25 more)
...
### Community 380 - "is"
Cohesion: 0.08
Nodes (52): armPageChatForTyping(), attachSteerFocusDebug(), attachSteerFocusGuard(), clearSteerAwaitTimer(), clearSteerFocusRecoverTimer(), collapsePageChat(), configureVoiceContext(), expandPageChat() (+44 more)

### Community 381 - "IssueController"
Cohesion: 0.17
Nodes (9): FollowRepository, Follow, Repository, InteractionService, Comment, Follow, Service, Transactional (+1 more)

### Community 382 - "d1"
Cohesion: 0.33
Nodes (4): GeneratedPluginRegistrant, +registerWithRegistry, NSObject, shared_preferences_foundation
...
Cohesion: 0.08
Nodes (25): compilerOptions, allowArbitraryExtensions, allowImportingTsExtensions, erasableSyntaxOnly, esModuleInterop, forceConsistentCasingInFileNames, isolatedModules, jsx (+17 more)

### Community 386 - "gaH"
Cohesion: 0.07
Nodes (16): OncePerRequestFilter, AuditLog, Entity, PrePersist, Table, Component, FilterChain, HttpServletRequest (+8 more)

### Community 387 - ".doFilterInternal"
Cohesion: 0.05
Nodes (24): AuditLog, Entity, PrePersist, Table, Component, FilterChain, HttpServletRequest, HttpServletResponse (+16 more)
...
### Community 389 - "c9"
Cohesion: 0.06
Nodes (33): 1. System Boundaries, 2. Data Models, 3. Interaction Flows, A. Comment Entity, Architecture: Comprehensive User Interactions, B. Vote Entity (Like/Dislike), C. Follow Entity (Subscriptions), D. Notification Entity (+25 more)
...
### Community 391 - "gbi"
Cohesion: 0.09
Nodes (23): Appendix: Icon Consistency Reference (from DJ Decision Docx), 🧠 Behavioral Patterns, 🧠 Behavioral Patterns, Cross-Persona Feature Priority Matrix, 💡 Design Implications for Arjun, 💡 Design Implications for Sunita, 👤 Digital Janta Platform — User Personas, 😤 Frustrations & Pain Points (+15 more)
...
Cohesion: 0.10
Nodes (4): Comment, Entity, Table, User
...
Cohesion: 0.17
Nodes (14): wchar_t, Scale(), Create, Destroy, GetHandle, SetQuitOnClose, Win32Window::Win32Window(), WindowClassRegistrar (+6 more)

### Community 401 - "GlobalExceptionHandler.java"
Cohesion: 0.04
Nodes (75): JsonInclude, AuthController, Authentication, CrossOrigin, GetMapping, Operation, PostMapping, RequestMapping (+67 more)
...
### Community 404 - "IssueCreateRequestDto"
Cohesion: 0.08
Nodes (30): IssueController, Authentication, CrossOrigin, DeleteMapping, GetMapping, IssueCreateRequestDto, Operation, PostMapping (+22 more)
...
Cohesion: 0.12
Nodes (8): Entity, Table, User, Vote, Repository, Vote, VoteRepository, Vote

### Community 415 - "SecurityConfig.java"
Cohesion: 0.06
Nodes (27): Schema, UserDto, AuthResponseDto, UserDto, Entity, Table, User, RefreshToken (+19 more)
...
### Community 418 - "uR"
Cohesion: 0.21
Nodes (10): AuthController, Authentication, CrossOrigin, GetMapping, JwtTokenProvider, RequestMapping, ResponseEntity, RestController (+2 more)
...
### Community 423 - "IssueCreateRequestDto"
Cohesion: 0.12
Nodes (36): analyzeVisualContrastCandidate(), checkColors(), checkElementAIPaletteDOM(), checkElementColors(), checkElementColorsDOM(), checkElementGlowDOM(), checkElementHoverContrast(), checkElementIconTile() (+28 more)
...
Cohesion: 0.33
Nodes (5): ActuatorIntegrationTest, AutoConfigureMockMvc, MockMvc, Test, WithMockUser
...
### Community 431 - "eH"
Cohesion: 0.17
Nodes (18): getAuthToken(), fetchNotifications(), getUnreadCount(), markAsRead(), NotificationDto, BG_MAP, COLOR_MAP, FILTERS (+10 more)
...
Cohesion: 0.33
Nodes (6): 1. Role Overview & Designation, 2. Mandatory Inputs & Outputs, 3. Required Skills & Lifecycle Workflows, 4. Execution Checklist (`TDD Green Phase`), 5. Interaction Guide (`How to Invoke`), 🏗️ BE Builder Agent (`be-builder` / `be-agent`)
...
### Community 439 - "Pn"
Cohesion: 0.14
Nodes (26): isStopEvent(), appendDesignSystemNote(), bumpEditCount(), dedupeAgainstCache(), depthIsSet(), designSystemOptions(), ensureFile(), ensureSession() (+18 more)
...
### Community 445 - "gaO"
Cohesion: 0.15
Nodes (4): Follow, Entity, Table, User
...
Cohesion: 0.13
Nodes (14): BackendIssueDto, CreateIssuePayload, fetchIssues(), categoryIcons, FILTER_TABS, Issue, ISSUES, IssuesPage() (+6 more)
...
Cohesion: 0.12
Nodes (17): Topbar(), TopbarProps, DEFAULT_TOPICS, TopicFilterBarProps, createAction, sidebarItems, Sidebar(), SidebarItem (+9 more)
...
Cohesion: 0.22
Nodes (7): 📔 DJP Platform Technical Debt Resolution & Audit Log (Historical Ledger SSOT), 📋 How to Use This Log (Agent & Developer Instructions), 🛠️ Standard Resolution Entry Template, 🔴 1. Critical Debt (Active Blockers), 🟠 2. High Debt (Ready for Replenishment Queue), ⚙️ Autonomous Execution & Replenishment Loop, 📊 **DJP Platform Technical Debt & Audit Recommendations (Execution Backlog)**

### Community 453 - "Qy"
Cohesion: 0.13
Nodes (27): appendOriginToDirective(), applyNuxtLiveAdapter(), buildNuxtPlugin(), buildTagBlock(), commentClose(), commentOpen(), CONFIG_PATH, detectLineEnding() (+19 more)
...
### Community 464 - "oS"
Cohesion: 0.10
Nodes (37): checkElementGlow(), checkElementRadialSpotlight(), checkElementRadialSpotlightDOM(), checkGlow(), checkHtmlPatterns(), checkRadialSpotlight(), collectCssCustomProps(), collectMarqueeKeyframes() (+29 more)
...
Cohesion: 0.05
Nodes (41): Active Backlog — Next Phase, Completed Phases (Archived), Current Sprint, DJP PROTOTYPE FRONTEND ACTIVE STATE, Future (Low Priority), Phase 5 — Fix Broken Flows, 10. FeedPage "Petitions" Filter — No Data, 11. No Loading/Error States for TanStack Query (+33 more)

### Community 470 - "Card.tsx"
Cohesion: 0.12
...
Cohesion: 0.12
Nodes (18): ResponseStatus, ResourceNotFoundException, Authentication, GetMapping, Operation, PatchMapping, RequestMapping, ResponseEntity (+10 more)
...
### Community 477 - "SidebarContext.tsx"
Cohesion: 0.40
Nodes (3): SidebarContextType, SidebarContext, SidebarProvider()
...
### Community 480 - "a4j"
Cohesion: 0.15
Nodes (24): browserFindingsFromMap(), checkCreamPalette(), checkEdgeFlushCardsDOM(), checkElementBlinkingCursorDOM(), checkElementPseudoStripeDOM(), checkElementTextOverflowDOM(), checkFirstViewportColumnOverflowDOM(), checkHeadingRhythmDOM() (+16 more)

### Community 481 - "installInstanceTearOff"
Cohesion: 0.11
Nodes (19): gaeW(), gaeZ(), gaf7(), gaf8(), gt5(), sapF(), sAZ(), sbH() (+11 more)
...
Cohesion: 0.11
Nodes (16): completeUserOnboarding(), OnboardingResponse, OnboardingUpdateRequest, OnboardingContext, OnboardingLayoutProps, StepInfo, STEPS, DEFAULT_DATA (+8 more)

### Community 486 - "DiscussionsPage.tsx"
Cohesion: 0.09
Nodes (22): Assess Onboarding Needs, Context Over Ceremony, Contextual Help, Design Onboarding Experiences, Documentation & Help, Empty State Design, Feature Discovery & Adoption, Guided Tours & Walkthroughs (+14 more)

### Community 487 - "SidebarContext.tsx"
Cohesion: 0.15
...
### Community 488 - "ResourceNotFoundException"
Cohesion: 0.08
Nodes (26): List, ObjectMapper, CrossOrigin, GetMapping, Operation, PatchMapping, RequestMapping, ResponseEntity (+18 more)
...
### Community 494 - "ResourceNotFoundException"
Cohesion: 0.08
Nodes (27): DiscussionController, Authentication, CrossOrigin, DeleteMapping, GetMapping, Operation, PostMapping, PutMapping (+19 more)
...
### Community 509 - "PollsPage.js"
Cohesion: 0.15
Nodes (17): InsightsController, CrossOrigin, GetMapping, Operation, RequestMapping, ResponseEntity, RestController, Tag (+9 more)
...
### Community 515 - "SidebarContext.js"
Cohesion: 0.18
Nodes (14): addBrowserFindings(), addVisualContrastFindings(), addVisualContrastResult(), analyzeVisualContrast(), clearOverlays(), detachOverlay(), disconnectLazyVisualContrastObserver(), postExtensionError() (+6 more)
...
### Community 522 - "a2H"
Cohesion: 0.03
Nodes (98): a2l(), a38(), a3g(), a5w(), a7B(), a7h(), a7j(), aAS() (+90 more)

### Community 523 - "QU"
Cohesion: 0.10
Nodes (37): agentHasWorkInFlight(), agentStatusText(), barPaletteForTheme(), brandMarkSvg(), buildDesignHeader(), buildSavingRow(), buildSteerProcessingDots(), cursorForInsertAxis() (+29 more)
...
### Community 525 - "aKX"
Cohesion: 0.24
Nodes (6): Notification, Repository, NotificationRepository, Notification, Service, NotificationService
...
### Community 532 - "ResourceNotFoundException"
Cohesion: 0.22
Nodes (13): aOI(), gajH(), jw(), qA(), sBc(), syi(), szV(), uc() (+5 more)

### Community 534 - "BaseIntegrationTest.java"
Cohesion: 0.48
Nodes (5): JdbcTemplate, BaseIntegrationTest, ActiveProfiles, AfterEach, SpringBootTest
...
### Community 539 - "DiscussionDetailPage.tsx"
Cohesion: 0.18
...
### Community 541 - "NotificationsPage.js"
Cohesion: 0.14
Nodes (14): scripts, build, contract:refresh, contract:types, contract:validate, dev, e2e, e2e:ui (+6 more)

### Community 542 - "NotificationsPage.tsx"
Cohesion: 0.21
...
### Community 543 - "PetitionsPage.js"
Cohesion: 0.12
...
### Community 544 - "PetitionsPage.tsx"
Cohesion: 0.12
Nodes (14): Accessibility and control, Choose material by meaning, Find the job, Implement to the runtime, Set the motion thesis, Timing and easing, Verify, Visitor mode (+6 more)

### Community 545 - "PollsPage.js"
Cohesion: 0.12
Nodes (16): 1. Read the screenshot (if present), 2. Wrap the element, 3. Load the action's reference, 4. Plan three variants: identity first, then mode, then axes, 5. Apply the freeform prompt (if present), 6. Deliver variants, 7. Parameters (composition-sized, 0–4 per variant), 8. Signal done (+8 more)

### Community 546 - "PollsPage.tsx"
Cohesion: 0.33
Nodes (5): 1. Overview & File Locations, 2. Quickstart & Import Instructions, 3. Endpoints Covered, 4. Mandatory Maintenance Rule (For AI Agents & Developers), Canonical Postman Collection Guide & API Maintenance Protocol

### Community 547 - "ProfilePage.js"
Cohesion: 0.03
Nodes (115): a1P(), a1R(), a1Y(), a28(), a2D(), a2I(), a2P(), a2S() (+107 more)

### Community 548 - "ProfilePage.tsx"
Cohesion: 0.19
...
Cohesion: 0.22
Nodes (6): BM25, BM25 ranking algorithm for text search, Lowercase, normalize synonyms, split, remove punctuation, filter stopwords, Build BM25 index from documents, Score all documents against query, TestTokenizer
...
### Community 582 - "kD"
Cohesion: 0.24
Nodes (9): IssueIntegrationTest, AfterEach, AuditLogRepository, AutoConfigureMockMvc, IssueRepository, JwtTokenProvider, MockMvc, Test (+1 more)
...
### Community 591 - "Prototype API & Postman Collection Guide (`web-app = prototype`)"
Cohesion: 0.40
Nodes (4): 1. Overview & File Location, 2. Automatic JWT Authentication (Zero-Config Testing), 3. Mandatory Maintenance Protocol, Prototype API & Postman Collection Guide (`web-app = prototype`)

### Community 596 - "OnboardingLayout.js"
Cohesion: 0.23
...
### Community 597 - "Step1BasicInfo.js"
Cohesion: 0.15
...
### Community 598 - "Step1BasicInfo.tsx"
Cohesion: 0.15
...
### Community 599 - "Step3About.js"
Cohesion: 0.15
Nodes (12): Design Specificity Verdict, Impeccable Design Critique: prototype, Minor Observations, Overall Impression, [P0] Forced & High-Friction Onboarding Loop, [P1] High Cognitive Load & Dashboard Overcrowding, [P1] Typographic & Theme Fragmentation (The Style Rift), [P2] Form Validation & Error Prevention (+4 more)

### Community 600 - "Step3About.tsx"
Cohesion: 0.27
Nodes (13): gLY(), gpc(), sao4(), sbD(), scU(), scV(), sGv(), sj0() (+5 more)

### Community 602 - "OTPPage.js"
Cohesion: 0.17
...
### Community 603 - "InsightsPage.tsx"
Cohesion: 0.17
Nodes (11): Accessibility Resilience, Assess Hardening Needs, Edge Cases & Boundary Conditions, Error Handling, Hardening Dimensions, Input Validation & Sanitization, Internationalization (i18n), Performance Resilience (+3 more)

### Community 604 - "IssueDetailPage.tsx"
Cohesion: 0.18
Nodes (10): DJP Archived Tasks, Migration Sprint — Completed 2026-07 (100% — 35/35 tasks), Notes, Phase 0 — Foundation, Phase 1 — Core Pages (P1), Phase 2 — Supporting Pages (P2), Phase 3 — Detail & Creation Pages (P3), Phase 4 — Auth & Onboarding (+2 more)

### Community 605 - "RepresentativesPage.js"
Cohesion: 0.23
...
### Community 606 - "RepresentativesPage.tsx"
Cohesion: 0.19
Nodes (12): _domain_keywords(), _get_bm25(), _load_csv(), _load_product_keywords(), _normalize(), Apply synonym substitution before tokenizing., Load CSV and return list of dicts, with mtime-based caching., Fitted BM25 index for this file+columns, with mtime-based caching. (+4 more)

### Community 607 - "Card.js"
Cohesion: 0.17
Nodes (11): Accessibility & Inclusion, Brand Commitments, Capabilities and Constraints, Evidence on Hand, Operating Context, Platform, Positioning, Product (+3 more)

### Community 608 - "AppLayout.js"
Cohesion: 0.18
...
### Community 610 - "sidebar.constants.js"
Cohesion: 0.18
Nodes (11): 10. Help and Documentation, 1. Visibility of System Status, 2. Match Between System and Real World, 3. User Control and Freedom, 4. Consistency and Standards, 5. Error Prevention, 6. Recognition Rather Than Recall, 7. Flexibility and Efficiency of Use (+3 more)

### Community 611 - "Avatar.js"
Cohesion: 0.18
...
### Community 614 - "USER.md"
Cohesion: 0.07
Nodes (27): a33(), a9R(), aB(), dW(), Gj(), gP0(), saha(), sajK() (+19 more)
...
### Community 656 - "UserDto.java"
Cohesion: 0.18
Nodes (10): Assess Current State, Color Refinement, Composition Refinement, Motion Reduction, Plan Refinement, Refine the Design, Simplification, Verify Quality (+2 more)

### Community 657 - "App.js"
Cohesion: 0.35
Nodes (10): detectCsp(), INLINE_HEADER_SIGNALS, LAYOUT_EXTS, MONOREPO_HELPER_SIGNALS, NUXT_ROUTE_RULES_SIGNALS, NUXT_SECURITY_SIGNALS, SCAN_EXTS, SKIP_DIRS (+2 more)

### Community 661 - "router.js"
Cohesion: 0.35
...
### Community 662 - "router.tsx"
Cohesion: 0.24
Nodes (7): args, buildWeights(), hashUnit(), pickSeed(), seed, SEEDS, weightedPick()

### Community 663 - "DiscussionDetailPage.tsx"
Cohesion: 0.11
Nodes (35): DiscussionDetailPage(), DISCUSSIONS_DATA, tagVariantMap, UUID_TO_MOCK_KEY, DiscussionData, DiscussionMeta, DiscussionPoll, DiscussionRelated (+27 more)

### Community 664 - "LoginPage.tsx"
Cohesion: 0.27
Nodes (8): BackendPollDto, CreatePollPayload, fetchPolls(), FILTER_TABS, Poll, PollOption, POLLS, PollsPage()

### Community 665 - "Step2Location.js"
Cohesion: 0.21
Nodes (12): EditProfileModal(), ProfilePage(), fetchUser(), fetchUserStats(), getAuthToken(), ProfileUpdatePayload, updateProfile(), UserDto (+4 more)

### Community 666 - "Step2Location.tsx"
Cohesion: 0.20
...
### Community 671 - "NotFoundPage.js"
Cohesion: 0.23
Nodes (9): AfterReturning, Aspect, JoinPoint, AuditLoggingAspect, AuditLog, AuditLogService, Component, Logger (+1 more)

### Community 672 - "NotFoundPage.tsx"
Cohesion: 0.25
Nodes (4): 1. UI Icon & Component Consistency, 2. Global Data ID Propagation, UI and Data Consistency Guardrail, Definition of Done (DoD)

### Community 673 - "InsightsPage.js"
Cohesion: 0.25
Nodes (8): 1. Impatient Power User: "Alex", 2. Confused First-Timer: "Jordan", 3. Accessibility-Dependent User: "Sam", 4. Deliberate Stress Tester: "Riley", 5. Distracted Mobile User: "Casey", Persona-Based Design Testing, Project-Specific Personas, Selecting Personas

### Community 674 - "IssuesPage.js"
Cohesion: 0.25
Nodes (7): Extract Flow, Step 1: Discover the Design System, Step 2: Identify Patterns, Step 3: Plan Extraction, Step 4: Extract & Enrich, Step 5: Migrate, Step 6: Document

### Community 676 - "Input.js"
Cohesion: 0.25
...
### Community 678 - "Topbar.js"
Cohesion: 0.33
Nodes (6): AuditLogService, AuditLog, AuditLogRepository, Logger, Service, Transactional

### Community 679 - "Sidebar.js"
Cohesion: 0.29
Nodes (10): extract_fetch_calls(), get_fe_endpoints(), load_spec(), main(), normalize_path_param_names(), Extract all FE fetch() endpoints grouped by file., Normalize all path parameter names to {id} for comparison., Extract (method, url_template) pairs from a source file. (+2 more)

### Community 680 - "inline-ignores.mjs"
Cohesion: 0.12
Nodes (24): collectStaticCssText(), checkStaticPageTypography(), detectHtml(), STATIC_ELEMENT_RULES, checkCreamPalette(), checkElementGlow(), checkPageLayout(), checkPageQualityDOM() (+16 more)

### Community 681 - "Persona 6: Arjun Patil — *"The Aspiring Ward Leader"*"
Cohesion: 0.32
...
### Community 682 - "SidebarFooter.tsx"
Cohesion: 0.11
Nodes (18): aF(), ga3j(), gMJ(), N6(), Rv(), saoa(), sda(), shj() (+10 more)

### Community 683 - "CreatePostPage.tsx"
Cohesion: 0.12
Nodes (20): CreateDiscussionForm(), CreateDiscussionFormProps, CreateIssueForm(), CreateIssueFormProps, CreatePetitionForm(), CreatePollForm(), CreatePollFormProps, CreatePostPage() (+12 more)

### Community 684 - "SidebarHeader.tsx"
Cohesion: 0.29
Nodes (7): Android platform, Color & theming, Components & motion, Layout & structure, The Android slop test, Touch targets, Typography

### Community 685 - "SidebarNav.js"
Cohesion: 0.29
...
### Community 686 - "SidebarNav.tsx"
Cohesion: 0.29
Nodes (7): Cognitive Load Assessment, Cognitive Load Checklist, Extraneous Load: Bad Design, Germane Load: Learning Effort, Intrinsic Load: The Task Itself, The Working Memory Rule, Three Types of Cognitive Load

### Community 687 - "SidebarNavItem.js"
Cohesion: 0.43
Nodes (3): detect_domain(), Auto-detect the most relevant domain from query.      Matches are weighted by ke, TestDomainDetection

### Community 688 - "EmptyState.js"
Cohesion: 0.31
Nodes (9): cursorBlockMessage(), clampGroupedToBudget(), clampToBudget(), directiveFooter(), formatFindingIgnoreCommand(), formatFindingLine(), quoteCommandArg(), renderGroupedTemplate() (+1 more)

### Community 689 - "checkElementDesignSystemDOM"
Cohesion: 0.22
Nodes (8): email, fromJson, id, name, reputationScore, role, toJson, User

### Community 730 - "index.js"
Cohesion: 0.20
Nodes (9): 1. TDD Process Violation (`-1 Point`), 2. State Tracker Inaccuracy (`-1 Point`), 3. Invalid Tool Usage (Tool Call Error) (`-1 Point`), 4. State Management (Lifting State Up) (`-1 Point`), 5. Metadata Maintenance (`-1 Point`), 6. Component Consistency (Incomplete Application) (`-1 Point`), 7. Missing Component Props / Silent Failures (`-1 Point`), Antigravity: Training & Error Log (+1 more)

### Community 731 - "index.ts"
Cohesion: 0.33
Nodes (5): Before you finish, Scope is sovereign, The amplification, The skeleton test, Why it reads flat

### Community 732 - "main.js"
Cohesion: 0.33
Nodes (6): Constraints, Failure modes, Flow, $impeccable hooks, Intentional findings, Routing

### Community 733 - "main.tsx"
Cohesion: 0.33
...
### Community 734 - "UserRepository"
Cohesion: 0.53
Nodes (3): Repository, User, UserRepository

### Community 735 - "DiscussionsPage.tsx"
Cohesion: 0.33
Nodes (5): 1. Overview & File Locations, 2. Quickstart & Import Instructions, 3. Endpoints Covered, 4. Mandatory Maintenance Rule (For AI Agents & Developers), Canonical Postman Collection Guide & API Maintenance Protocol

### Community 736 - "OAuth2SuccessHandler"
Cohesion: 0.39
Nodes (8): generate(), Resolve $ref to schema name., Render a TS interface body., render_type(), resolve_ref(), resolve_ts_type(), to_camel(), to_pascal()

### Community 737 - "NotFoundPage.tsx"
Cohesion: 0.40
Nodes (4): Antigravity: System Overview, Core Directives, Identity, Operating Principles

### Community 738 - "PollsPage.js"
Cohesion: 0.50
Nodes (3): Antigravity: Skills & Capabilities, Built-in Agentic Tools, Loaded Domain Plugins & Skills

### Community 739 - "PollsPage.tsx"
Cohesion: 0.50
Nodes (4): Heuristics Scoring Guide, Issue Severity (P0–P3), Reference Material, Score Summary

### Community 740 - "ProfilePage.js"
Cohesion: 0.50
Nodes (3): candidates, detectorPath, __dirname

### Community 741 - "AuthIntegrationTest"
Cohesion: 0.31
Nodes (7): BackendDiscussionDto, CreateDiscussionPayload, fetchDiscussions(), badgeVariantStyles, Discussion, DISCUSSIONS, DiscussionsPage()

### Community 742 - "index.js"
Cohesion: 0.83
Nodes (3): _check_file(), main(), _read_rows()

### Community 743 - "AuthIntegrationTest"
Cohesion: 0.25
Nodes (8): 🧠 Behavioral Patterns, 💡 Design Implications for Rajan, 😤 Frustrations & Pain Points, 🎯 Goals & Motivations, 📊 Key Metrics to Track for This Persona, Persona 2: Rajan Malhotra — *"The Civic Watchdog"*, 📋 Profile Summary, 📱 User Journey (Typical Session)

### Community 745 - "MessageHandler"
Cohesion: 0.29
Nodes (6): Component, FilterChain, Override, ServletRequest, ServletResponse, MdcFilter

### Community 747 - "FE ↔ BE Contract Testing"
Cohesion: 0.25
Nodes (7): FE ↔ BE Contract Testing, Files, Generate TypeScript types, Refresh the spec (after backend changes), Validate frontend matches the spec, When to run, Workflow

### Community 758 - "SecurityConfig.java"
Cohesion: 0.28
Nodes (9): Bean, Configuration, CorsConfigurationSource, EnableWebSecurity, HttpSecurity, JwtAuthenticationFilter, OAuth2SuccessHandler, SecurityFilterChain (+1 more)

### Community 759 - "InteractionIntegrationTest"
Cohesion: 0.08
Nodes (27): AutoConfigureMockMvc, MockMvc, Test, OpenApiIntegrationTest, MediaType, CrossOrigin, GetMapping, MultipartFile (+19 more)

### Community 760 - "MessageHandler"
Cohesion: 0.38
Nodes (10): HWND, LPARAM, LRESULT, UINT, WPARAM, EnableFullDpiSupportIfAvailable(), GetThisFromHandle, MessageHandler (+2 more)

### Community 761 - "collectVisualContrastCandidates"
Cohesion: 0.22
Nodes (11): buildSelectorSegment(), collectVisualContrastCandidates(), collectVisualContrastReasons(), generateSelector(), getDirectText(), getDirectTextRect(), isLikelyHashedClass(), postSerializedFindings() (+3 more)

### Community 762 - "ResourceNotFoundException"
Cohesion: 0.25
Nodes (8): 🧠 Behavioral Patterns, 💡 Design Implications for Ananya, 😤 Frustrations & Pain Points, 🎯 Goals & Motivations, 📊 Key Metrics to Track for This Persona, Persona 1: Ananya Sharma — *"The Concerned Citizen"*, 📋 Profile Summary, 📱 User Journey (Typical Session)

### Community 763 - "normalizeGitHubEvent"
Cohesion: 0.38
...
### Community 764 - "Persona 3: Priya Deshmukh — *"The Community Organizer"*"
Cohesion: 0.25
Nodes (8): 🧠 Behavioral Patterns, 💡 Design Implications for Priya, 😤 Frustrations & Pain Points, 🎯 Goals & Motivations, 📊 Key Metrics to Track for This Persona, Persona 3: Priya Deshmukh — *"The Community Organizer"*, 📋 Profile Summary, 📱 User Journey (Typical Session)

### Community 765 - "main.tsx"
Cohesion: 0.43
Nodes (3): router, queryClient, QueryProvider()

### Community 766 - "Change Map"
Cohesion: 0.33
Nodes (5): Allowed Change Zones, Change Map, Data Interface Zones, Protected Eval Zones, Single-Variable High-Risk Zones

### Community 767 - "copyProperties"
Cohesion: 0.33
Nodes (6): copyProperties(), inherit(), inheritMany(), setOrUpdateInterceptorsByTag(), setOrUpdateLeafTags(), updateHolder()

### Community 768 - "test_core.py"
Cohesion: 0.40
Nodes (5): ensureHookGitExcludes(), escapeRegExp(), persistCache(), resolveGitDir(), resolveHookGitExcludeTarget()

### Community 769 - "j8"
Cohesion: 0.40
Nodes (4): Eval Contract, Evaluation Source, Expected Artifacts, Notes

### Community 770 - "Research Map"
Cohesion: 0.40
Nodes (4): Entrypoints, Output Hints, Research Map, Task-Relevant Files

### Community 771 - "package.json"
Cohesion: 0.40
Nodes (4): name, private, type, version

### Community 772 - "Project Analysis Summary"
Cohesion: 0.50
Nodes (3): Additional Documents, Conservative Suggestions, Project Analysis Summary

### Community 774 - "AuditLog.java"
Cohesion: 0.83
Nodes (3): AuditLog, Retention, Target

### Community 775 - "BORDER_SAFE_TAGS"
Cohesion: 0.43
...
### Community 784 - "CommentRepository"
Cohesion: 0.53
Nodes (3): CommentRepository, Comment, Repository

### Community 785 - "warn"
Cohesion: 0.60
Nodes (3): gradlew script, die(), warn()

### Community 786 - "OpenApiConfig.java"
Cohesion: 0.70
Nodes (4): Configuration, OpenAPIDefinition, SecurityScheme, OpenApiConfig

## Knowledge Gaps
- **2566 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `COMMON_DEV_PORTS` (+2561 more)
...
- **Why does `c()` connect `DiscussionDetailPage.tsx` to `Skill Creator`, `run_loop`, `a2H`, `HI`, `generate_review.py`, `ResourceNotFoundException`, `DiscussionDetailPage.js`, `HY`, `ProfilePage.js`, `Find Skills`, `Test-Driven Development`, `IssueCreateRequestDto`, `JSON Schemas`, `vP`, `JwtTokenProvider`, `Button.tsx`, `IssueCreateRequestDto`, `t`, `.$1`, `$0`, `axZ`, `SidebarContext.tsx`, `start-server.sh`, `RepresentativesPage.tsx`, `IssueDetailPage.tsx`, `gK`, `collectVisualContrastCandidates`, `com.djp:backend`?**
  _High betweenness centrality (0.152) - this node is a cross-community bridge._
- **Why does `createRequestHandler()` connect `JSON Schemas` to `HY`, `ProfilePage.tsx`, `DiscussionDetailPage.tsx`, `AC`, `cW`, `gbj`, `GlobalExceptionHandler.java`, `FeedPage.js`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `i()` connect `t` to `Skill Creator`, `a2H`, `generate_review.py`, `ResourceNotFoundException`, `CreatePollPage`, `DiscussionDetailPage.tsx`, `Find Skills`, `ProfilePage.js`, `index.ts`, `SidebarFooter.tsx`, `JwtTokenProvider`, `Qd`, `vK`, `aAS`, `aJZ`, `Button.tsx`, `IssueCreateRequestDto`, `.$1`, `$0`, `axZ`, `installInstanceTearOff`, `DiscussionDetailPage.tsx`, `USER.md`, `RepresentativesPage.tsx`, `IssueDetailPage.tsx`, `gK`, `DiscussionDetailPage.js`, `index.ts`, `DiscussionsPage.js`, `com.djp:backend`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Are the 218 inferred relationships involving `a()` (e.g. with `parseRadialGradientStops()` and `scanCssTextForRadialHalo()`) actually correct?**
  _`a()` has 218 INFERRED edges - model-reasoned connections that need verification._
- **Are the 418 inferred relationships involving `b()` (e.g. with `discoverTargetCandidates()` and `gitSignals()`) actually correct?**
  _`b()` has 418 INFERRED edges - model-reasoned connections that need verification._
- **Are the 136 inferred relationships involving `i()` (e.g. with `fe()` and `jt()`) actually correct?**
  _`i()` has 136 INFERRED edges - model-reasoned connections that need verification._
- **Are the 408 inferred relationships involving `c()` (e.g. with `buildSelectorSegment()` and `buildSelectorSegment()`) actually correct?**
  _`c()` has 408 INFERRED edges - model-reasoned connections that need verification._