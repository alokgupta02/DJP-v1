      ...
      {!isCollapsed && (
        <div className="flex">
          ...
          >
            ...
            <div className="absolute top-2 bg-[var(--color-bg-surface)] border border-[var(--color-border)] text-[var(--color-text-secondary)] shadow-sm rounded-full p-0.5 transition-all hover:bg-[var(--color-brand)] hover:text-white hover:border-[var(--color-brand)]">
